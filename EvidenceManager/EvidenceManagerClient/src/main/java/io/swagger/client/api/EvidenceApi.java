...
public class EvidenceApi {
    ...
    private com.squareup.okhttp.Call getEvidenceListCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        

        // create path and map variables
        String localVarPath = "/evidence".replaceAll("\\{format\\}","json");
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Evidence> getEvidenceList() throws ApiException {
        ApiResponse<List<Evidence>> resp = getEvidenceListWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Evidence>> getEvidenceListWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getEvidenceListCall(null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getEvidenceListAsync(final ApiCallback<List<Evidence>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getEvidenceListCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Evidence>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
