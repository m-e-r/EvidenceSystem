...
public class UserApi {
    ...
    /**
     * Adds a user (asynchronously) adds a user
     *
     * @param user (required)
    ...
    /**
     * Gets a list of the users with a location Returns a list of users with the
     * location
     *
     * @param token (required)
     * @return List&lt;User&gt;
    ...
    /**
     * Gets a list of the users with a location (asynchronously) Returns a list
     * of users with the location
     *
     * @param token (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Gets a user based on Id Retuns a user
     *
     * @param id (required)
     * @return User
     * @throws ApiException If fail to call the API, e.g. server error or cannot
    ...
    /**
     * Gets a user based on Id (asynchronously) Retuns a user
     *
     * @param id (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * updates the users information updates a user
     *
     * @param user (required)
     * @return Boolean
     * @throws ApiException If fail to call the API, e.g. server error or cannot
    ...
    /**
     * updates the users information (asynchronously) updates a user
     *
     * @param user (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
